...
class App extends React.Component {
    ...
    render() {
        ...
        let myAccount = AccountStore.getState().currentAccount;
        ...
        if (this.state.syncFail) {
            ...
            content = (
                <div className="grid-frame vertical">
                    {AccountStore.getState().currentAccount && this.props.location.pathname.indexOf("account-register") === -1 ?
                        <Header height={this.state.height}/> : null}
                    <div className="grid-block" style={{height: 522}}>
        ...
        let bgImage = require("assets/bg.png");
        return (
            <div style={{backgroundColor: !this.state.theme ? "#2a2a2a" : null, backgroundImage: "url("+bgImage+")"}} className={this.state.theme}>
                <div id="content-wrapper" style={{background: "none"}}>
                    {content}
                    <NotificationSystem
