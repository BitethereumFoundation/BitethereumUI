...
class PasswordInput extends Component {
    ...
    render() {
        ...
        if(this.state.wrong || this.props.wrongPassword) password_error = <div style={{float: "left", width: "150px", paddingLeft: 20, paddingTop: 10, fontSize: 14}}><Translate content="wallet.pass_incorrect" /></div>;
        ...
        return (
            <div className="account-selector">
                <div className={password_class_name} style={{marginBottom: 0}}>
                    {/* {noLabel ? null : <Translate component="label" content="wallet.password" />} */}
                    <section>
                        <label className="left-label" style={{fontSize: 16, color: "#4d4d4d", padding: 20, borderBottom: "1px solid #e0e0e0", margin: 0}}>
                            <Translate content="wallet.wallet_modal_unlock" /></label>
                        <div style={{padding: "18px 20px", borderBottom: "1px solid #e0e0e0"}}>
                            {/*<Translate style={{fontSize: 14, lineHeight: "34px", display: "inline-block", color: "#4d4d4d"}} content="wallet.password"/>*/}
                            <input
                                style={{marginBottom: this.props.checkStrength ? 0 : null, backgroundColor: "#ffffff", color: "#000000", border: "1px solid #e0e0e0",
                                    width: 392, height: 34, display: "inline-block", margin: "0px"
                                    }}
                                name="password"
                                type="password"
                                ref="password"
