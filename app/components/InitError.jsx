...
class InitError extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="grid-block page-layout" style={{background: "#fff"}}>
                <div className="grid-container">
                    <div className="grid-content no-overflow">
                        ...
                        <section className="block-list">
                            ...
                            <ul>
                                <li className="with-dropdown" style={{paddingBottom: 40}}>

                                    <select onChange={this.onChangeWS.bind(this)} value={this.props.apiServer} style={{border: "1px solid rgba(128, 128, 128, 0.45)"}}>
                                        {options}
                                    </select>
