        ...
        display_history.push(
            <tr className="total-value" key="total_value">
                ...
                {/*<td style={alignRight}>*/}
                    ...
                    {/*</span> : null}*/}
                {/*</td>*/}
                {this.props.showMore && historyCount > this.state.limit || 20 && limit < historyCount ?
                    <td colSpan="3" style={alignRight}>
                        &nbsp;<a onClick={this._onIncreaseLimit.bind(this)}>
                        <Translate content="account.more" style={{color: "#539cf2"}} />
                    </a>
                    </td> : null}
                {/*// <td colSpan="3" style={alignRight}>*/}
                {/*//     &nbsp;{this.props.showMore && historyCount > this.state.limit || 20 && limit < historyCount ? (*/}
                {/*//         <a onClick={this._onIncreaseLimit.bind(this)}>*/}
                {/*//             <span style={{color: "#539cf2"}}>查看更多历史记录</span>*/}
                {/*//         </a>*/}
                {/*//     ) : null}*/}
                {/*// </td>*/}
            </tr>
            ...
            <div className="recent-transactions" style={style} >
                <div className="generic-bordered-box" >
                    <div
                        ...
                        ref="transactions">
                        <table className="table dashboard-table" style={{fontFamily: "Microsoft Yahei", height: "100%"}} >
                            <thead>
                                <tr>
                                    {/*{compactView ? null : <th style={alignLeft} className="column-hide-tiny">*/}
                                        ...
                                        {/*) : null}*/}
                                    {/*</th>}*/}
                                    <th style={{textAlign: "left", fontSize: 14}}><Translate content="operation.title" /></th>
                                    <th style={{textAlign: "left", fontSize: 14}}><Translate content="account.votes.info" /></th>
                                    <th style={{textAlign: "left", fontSize: 14}}><Translate content="operation.time" /></th>
                                </tr>
                            </thead>
                            <TransitionWrapper
                                component="tbody"
