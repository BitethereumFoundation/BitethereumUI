...
class TransactionLabel extends React.Component {
    ...
    render() {
        ...
        return (
            <span className={labelClass} style={{borderColor: "#539cf2", color: "#539cf2", background: "#ffffff"}}>
...
class Row extends React.Component {
    ...
    render() {
        ...
        if( block > last_irreversible_block_num ) {
            pending = <span>(<Translate content="operation.pending" blocks={block - last_irreversible_block_num}  style={{fontSize: 12}}/>)</span>;
        }
        ...
        return (
                <tr>
                    ...
                    <td style={{ textAlign: "left"}}>
                        ...
                        {pending ? <div style={{fontSize: 14, paddingTop: 5}}><span> - {pending}</span></div> : null}
...
class Operation extends React.Component {
    ...
    render() {
        ...
        switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
                    ...
                    <span className="right-td">
                        <TranslateWithLinks
                            ...
                            keys={[
                                ...
                                {type: "amount", value: op[1].amount, arg: "amount", decimalOffset: null},
            ...
            case "airdrop_balance_claim":
                column = (
                    <TranslateWithLinks
                        string="operation.airdrop_balance_claim"
                        keys={[
                            {type: "account", value: op[1].account_to_deposit, arg: "account"},
                            {type: "address_type", value: op[1].address_type, arg: "address_type"}
                        ]}
                        noLink={true}
                    />
                );
