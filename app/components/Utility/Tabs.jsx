...
class Tab extends React.Component {
    ...
    render() {
        ...
        return (
            <li className={c} onClick={!disabled ? changeTab.bind(this, index) : null} style={{height: 44, width: 102}}>
                <a style={{height: 44, fontSize: 16}} >
...
class Tabs extends React.Component {
    ...
    render() {
        ...
        const collapseTabs = false;  //this.state.width < 900;
