...
export default class PasswordConfirm extends Component {
        ...
        return (
            ...
            >
                    ...
                    <input
                        ...
                        tabIndex={tabIndex++}
                        className="password-change no-margin"
                    />
                    </section>

                <div style={{padding: "10px 0px 5px 0px", height: 35, fontSize: 14}}>{errors.get("password_match") || errors.get("password_length")}</div>
    ...
    validate(state) {
        ...
        if(password.length !== 0 && password.length < 8)
            errors = errors.set("password_length", counterpart.translate("account.password_input.password_length_limit"))

        // Don't report it until the confirm is populated
        if( password !== "" && confirm !== "" && password !== confirm)
            errors = errors.set("password_match",  counterpart.translate("account.password_input.different_repeat_password"))
