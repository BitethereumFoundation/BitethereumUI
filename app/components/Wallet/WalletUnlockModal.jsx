...
class WalletUnlockModal extends React.Component {
    ...
    renderWalletLogin() {
        ...
        return (
            <form className="full-width" onSubmit={this.onPasswordEnter} noValidate style={{paddingTop: 20, margin: "0", padding: 0}}>
                <PasswordInput
                    ref="password_input"
                ...
                <div style={{marginTop: 15}}>
                    <div className="button-group" style={{ position: "absolute", right: 20}}>
                        <button className="button"  data-html onClick={this.onPasswordEnter} style={{fontSize: 12, width: 64, height: 34}}>
                            <Translate content="modal.ok" />
                        </button>
                        <Trigger close={this.props.modalId}>
                            <div className=" button"  style={{fontSize: 12, width: 64, height: 34}}><Translate content="account.perm.cancel" /></div>
                        </Trigger>
                    </div>
                    {/* <div onClick={this._toggleLoginType.bind(this)} className="button small outline float-right"><Translate content="wallet.switch_model_password" /></div> */}
                </div>
