    ...
    render() {
        ...
        return (
            <div>
                ...
                {/*<span style={{display: "block", marginBottom: 20, fontSize: 14}}>*/}
                    {/*{counterpart.translate(`settings.backup_${types[restoreType]}`)}</span>*/}
                <Translate content={`settings.backup_${types[restoreType]}`} style={{display: "block", marginBottom: 20, fontSize: 14}} />
