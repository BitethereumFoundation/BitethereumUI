...
class IntlStore {
    constructor() {
        ...
        if(ss.has("settings_v3")){
            ss.remove("settings_v3");
        }
        this.currentLocale = ss.has("settings_v2") ? ss.get("settings_v2").locale : defaultLocale;

        this.locales = ["zh", "en"];
        this.localesObject = {zh: locale_zh, en: locale_en};
