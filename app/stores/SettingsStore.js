...
const CORE_ASSET = "BITE";
const STORAGE_KEY = "__bite__";
...
class SettingsStore {
    constructor() {
        ...
        let lang = (navigator.language||navigator.userLanguage).toLowerCase().substr(0,2);
        let defaultLocale = ( lang === "zh" || lang === "cn" ) ? "zh" : "en";
        ...
        this.settings = Immutable.Map(merge(this.defaultSettings.toJS(), ss.get("settings_v2")));
    ...
    onChangeSetting(payload) {
        ...
        ss.set("settings_v2", this.settings.toJS());
    }
