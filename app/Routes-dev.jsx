...
import AccountOperationHistory from "./components/Account/AccountOperationHistory";
import AccountPageStoreWrapper from "./components/Account/AccountPage";
...
const routes = (
    <Route path="/" component={App} onEnter={willTransitionTo}>
        ...
        <Route path="account/:account_name" component={AccountPageStoreWrapper} >
            <IndexRoute component={AccountOverview} />
            <Route path="dashboard" component={AccountOverview} />
            <Route path="operation-history" component={AccountOperationHistory} />
